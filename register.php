...
function sendMail($email,$otp){
  ...
  $mail->Password   = 'vqqirpnwrdjooyug';                            //
  $mail->SMTPSecure = 'tls';         
  $mail->Port       = 587;
        ...
        <div class="w3-half w3-container" style="margin-top: 50px; margin-bottom:50px;">
          ...
          <form name="registerForm" class="" action="register.php" method="post">
            ...
            <p>
              ...
              <label>This is protected by <a href="terms_of_service.php" class="terms">Terms of Service</a> and <a href="privacy_policy.php" class="terms">Privacy Policy</a></label>
            </p>
            <p>
